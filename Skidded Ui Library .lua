...
function module:New(name)
	...
	window.__index = window
        ...
        tabbuttons.ScrollBarImageColor3 = Color3.fromRGB(143, 143, 143)
        tabbuttons.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        tabbuttons.BackgroundColor3 = Color3.fromRGB(41, 41, 41)
        ...
        function window:NewTab(namee)
            ...
            tabbutton.BackgroundColor3 = Color3.fromRGB(168, 168, 168)
			...
			tabbutton.MouseLeave:Connect(function()
				tween(tabbutton,TweenInfo.new(0.4,Enum.EasingStyle.Linear),{BackgroundColor3 = Color3.fromRGB(168, 168, 168)})
			end)
            ...
            ScrollingFrame.ScrollBarImageColor3 = Color3.fromRGB(168, 168, 168)
            ...
            function tab:NewSearchBar()
                ...
                SearchBar.BackgroundColor3 = Color3.fromRGB(107, 107, 107)
			...
			button.ZIndex = 0
				...
				button.MouseButton1Up:Connect(function()
					...
					tween(button,TweenInfo.new(0.2,Enum.EasingStyle.Linear), {BackgroundColor3 = Color3.fromRGB(168, 168, 168)})
				end)
